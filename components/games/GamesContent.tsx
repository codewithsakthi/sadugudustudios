...
function ServiceCard({ service, index }: { service: typeof services[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay: (index % 3) * 0.1 + 0.1, duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
    ...
    >
      ...
      />
      {/* Card */}
      <div className="relative glass rounded-2xl p-6 h-full border border-white/5 group-hover:border-white/10 transition-all duration-500 overflow-hidden">
        {/* Tag */}
  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full bg-[#9b59b6]/4 blur-[150px]" />
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div ref={timelineRef} className="max-w-4xl mx-auto px-6 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <span className="text-xs tracking-[0.4em] uppercase text-[#f5c242]/60 block mb-4">
              The Roadmap
            </span>
            <h2
          ...
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#f5c242]/30 via-[#ff7a18]/20 to-transparent" />
            ...
            {timeline.map((item, i) => (
              ...
              >
                {/* Dot */}
                <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-5 h-5 rounded-full border-2 flex-shrink-0 z-10"
                  style={{ borderColor: item.color, background: `${item.color}20`, boxShadow: `0 0 12px ${item.color}50` }}
                />

                {/* Content */}
                <div className={`ml-20 md:ml-0 md:w-[45%] ${i % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16 md:ml-auto"}`}>
                  <div className="glass rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-all duration-300">
                    <div className="flex items-center gap-3 mb-3 ${i % 2 === 0 ? 'md:flex-row-reverse' : ''}">
                      ...
                      <div>
                        <div className="font-black text-xl" style={{ color: item.color, fontFamily: "Space Grotesk, sans-serif" }}>
                          {item.year}
                        </div>
      ...
      <section className="py-24 text-center px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <GlowButton href="/contact" variant="primary" size="lg">Get in Touch</GlowButton>
            <GlowButton href="/about" variant="outline" size="lg">Read Our Story</GlowButton>
          </div>
        </motion.div>
      </section>
    </div>
